...
const NavBare = () => {
  ...
  return (
    <div className="w-full h-full flex items-center justify-center z-[2000] bg-slate-300 ">
      <div className=" h-[61px] lg:w-[1024px] w-full px-10 flex items-center justify-between fixed top-0  bg-color-1">
        <Link href={"/"}>
